    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-white text-black border-2 border-black p-8 mb-8"
          >
            {/* Post Header */}
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-4">
                  {currentPost.isPinned && (
                    <span className="px-3 py-1 bg-black text-white text-sm font-mono">{t('post.pinned')}</span>
                  )}
                  <span className={`px-3 py-1 text-sm font-mono ${severityInfo.color}`}>
                    {severityInfo.icon} {t(severityInfo.labelKey).toUpperCase()}
                  </span>
                  <span className="px-3 py-1 bg-gray-100 text-gray-800 text-sm font-mono">
                    {scamTypeInfo.icon} {t(scamTypeInfo.labelKey).toUpperCase()}
                  </span>
                  {currentPost.isResolved && (
                    <span className="px-3 py-1 bg-green-100 text-green-800 text-sm font-mono flex items-center gap-1">
                ...
                <h1 className="text-3xl font-bold mb-4 font-mono">{currentPost.title}</h1>
                
                <div className="flex items-center gap-4 text-sm text-gray-600 mb-6 font-mono">
              ...
              <div className="flex items-center gap-4 pt-4 border-t-2 border-gray-200">
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-2 text-green-600 hover:bg-green-50 font-mono border-2 border-green-600"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 px-3 py-2 text-red-600 hover:bg-red-50 font-mono border-2 border-red-600"
                  >
              ...
              <div className="mb-8 p-4 bg-gray-50 border-2 border-gray-300">
                ...
                <div className="flex justify-end mt-3">
                  <button
                    ...
                    className="px-6 py-2 bg-black text-white hover:bg-gray-800 disabled:bg-gray-400 font-mono border-2 border-black flex items-center gap-2"
                  >
            ...
            {loadingComments ? (
              ...
              <div className="space-y-6">
                {comments.map((comment) => (
                  <div key={comment.id} className="border-2 border-gray-200 p-4">
                    {/* Comment Header */}
                    ...
                    {currentUser && (
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="flex items-center gap-1 px-2 py-1 text-green-600 hover:bg-green-50 text-sm font-mono"
                        >
                        ...
                        <button
                          ...
                          className="flex items-center gap-1 px-2 py-1 text-red-600 hover:bg-red-50 text-sm font-mono"
                        >
                      ...
                      <div className="mt-4 p-3 bg-gray-50 border-2 border-gray-300">
                        ...
                        <div className="flex justify-end gap-2 mt-2">
                          <button
                            ...
                            className="px-3 py-1 text-gray-600 hover:bg-gray-200 font-mono text-sm"
                          >
                            {t('common.cancel')}
                          </button>
                          <button
                            ...
                            className="px-3 py-1 bg-black text-white hover:bg-gray-800 disabled:bg-gray-400 font-mono text-sm"
                          >
                            {t('post.reply')}
                          </button>
                        </div>
                    ...
                    {comment.replies && comment.replies.length > 0 && (
                      <div className="mt-4 ml-6 space-y-4 border-l-2 border-gray-300 pl-4">
      ...
      {showReportModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white text-black p-6 max-w-md w-full mx-4 border-2 border-black">
