        ...
        <div className="flex-grow overflow-y-auto pr-4 -mr-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-1 space-y-4">
              ...
              <div><label className="label">Статус</label><select value={postData.status || 'draft'} onChange={e => handleFieldChange('status', e.target.value)} className="input"><option value="draft">Черновик</option><option value="published">Опубликовано</option></select></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-2">
            ...
            <button onClick={() => setShowCategoryModal(true)} className="btn-secondary flex items-center"><Folder className="h-4 w-4 mr-2" /> Управление категориями</button>
          </div>
        </div>
